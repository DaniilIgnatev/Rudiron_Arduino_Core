...
// CE (chip enable)
#define nRF24_CE_PORT              MDR_PORTC
#define nRF24_CE_PIN               PORT_Pin_2
#define nRF24_CE_PCLK              RST_CLK_PCLK_PORTC
#define nRF24_CE_L                 PORT_ResetBits(nRF24_CE_PORT, nRF24_CE_PIN)
#define nRF24_CE_H                 PORT_SetBits(nRF24_CE_PORT, nRF24_CE_PIN)

// CSN (chip select negative)
#define nRF24_CSN_PORT             MDR_PORTE
#define nRF24_CSN_PIN              PORT_Pin_1
#define nRF24_CSN_PCLK             RST_CLK_PCLK_PORTE
#define nRF24_CSN_L                PORT_ResetBits(nRF24_CSN_PORT, nRF24_CSN_PIN)
#define nRF24_CSN_H                PORT_SetBits(nRF24_CSN_PORT, nRF24_CSN_PIN)

// IRQ pin
#define nRF24_IRQ_PORT             MDR_PORTB
#define nRF24_IRQ_PIN              PORT_Pin_10
#define nRF24_IRQ_PCLK             RST_CLK_PCLK_PORTB


#define nRF24_GPIO_PERIPHERALS     nRF24_CE_PCLK | nRF24_CSN_PCLK | nRF24_IRQ_PCLK
